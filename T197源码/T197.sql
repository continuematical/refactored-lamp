...
DROP DATABASE IF EXISTS `t197`;
CREATE DATABASE IF NOT EXISTS `t197` /*!40100 DEFAULT CHARACTER SET utf8mb3 */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `t197`;
...
INSERT INTO `token` (`id`, `userid`, `username`, `tablename`, `role`, `token`, `addtime`, `expiratedtime`) VALUES
	(1, 6, 'admin', 'users', '管理员', 'ov55wgp7fy1owdxgurla7igjnsprrx0n', '2022-03-16 01:06:36', '2024-05-17 03:43:42'),
	(2, 1, 'a1', 'yuangong', '员工', 'smy8188ot2p71uhccoqnywus9m8a4zdo', '2022-03-16 01:31:43', '2024-05-17 03:44:29');
...
CREATE TABLE IF NOT EXISTS `medicine` (
  ...
  `uuid_number` varchar(200) DEFAULT NULL COMMENT '药品编号  Search111 ',
  `name` varchar(200) DEFAULT NULL COMMENT '药品名称  Search111 ',
  `effect` varchar(200) DEFAULT NULL COMMENT '药品功效  Search111 ',
  `illness` varchar(200) DEFAULT NULL COMMENT '所治疾病  Search111 ',
  `photo` varchar(200) DEFAULT NULL COMMENT '药品照片',
  `types` int DEFAULT NULL COMMENT '药品类型 Search111',
  `number` int DEFAULT NULL COMMENT '药品库存',
  `purchasing_price` decimal(10,2) DEFAULT NULL COMMENT '进价 ',
  `selling_price` decimal(10,2) DEFAULT NULL COMMENT '售价 ',
  `content` text COMMENT '药品介绍 ',
  `delete` int DEFAULT NULL COMMENT '逻辑删除',
  `create_time` timestamp NULL DEFAULT NULL COMMENT '创建时间 show1 show2 photoShow',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb3 COMMENT='药品';

DELETE FROM `medicine`;
INSERT INTO `medicine` (`id`, `gongyingshang_id`, `yaopin_uuid_number`, `yaopin_name`, `yaopin_gongxiao`, `yaopin_jibing`, `yaopin_photo`, `yaopin_types`, `yaopin_kucun_number`, `yaopin_jinjia_money`, `yaopin_xiaoshou_money`, `yaopin_content`, `yaopin_delete`, `create_time`) VALUES
