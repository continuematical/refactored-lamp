    ...
    <Card>
        <div slot="title">
            <div class="edit-head">
                ...
                <div class="head-name">排课申请详情</div>
                <span></span>
        ...
        <Form ref="form" :model="form" :label-width="100" :rules="formValidate" label-position="left">
            <FormItem label="排课名称" prop="scheduleName">
                <Input v-model="form.scheduleName" clearable style="width:570px" />
            </FormItem>
    ...
    methods: {
        ...
        handleSubmit() {
            this.$refs.form.validate(valid => {
                if (valid) {
                    editTeachingApply(this.form).then(res => {
