        ...
        <Row v-show="openSearch" @keydown.enter.native="handleSearch">
            <Form ref="searchForm" :model="searchForm" inline :label-width="0">
                <Form-item ref="searchForm" :model="searchForm" inline :label-width="0" style="display:flex;">
                    <Form-item label="" prop="scheduleName">
                        <Input type="text" v-model="searchForm.scheduleName" placeholder="排课名称" clearable style="width: 120px" />
                    </Form-item>
                    <Form-item label="" prop="userName">
                        <Input type="text" v-model="searchForm.userName" placeholder="申请人" clearable style="width: 120px" />
                    </Form-item>
                    <Form-item label="" prop="curriculumName">
                        <Input type="text" v-model="searchForm.curriculumName" placeholder="课程名称" clearable style="width: 120px" />
                    </Form-item>
                    <Form-item style="margin-left:10px;" class="br">
                        ...
                        <Button @click="workFx" type="success" icon="ios-settings" size="small" ghost :disabled="!$route.meta.permTypes.includes('enable')">开始排课</Button>
                        <Button @click="deleteAllFx" type="error" icon="ios-settings" size="small" ghost :disabled="!$route.meta.permTypes.includes('disable')">清理排课申请</Button>
                        <Button @click="excelData" type="success" icon="md-paper-plane" size="small" ghost>导出</Button>
                    </Form-item>
                    <Form-item style="position:fixed;right:50px;top:126px">
...
export default {
    ...
    methods: {
        ...
        getDataList() {
            this.loading = true;
            getTeachingApplyList(this.searchForm).then(res => {
                this.loading = false;
                if (res.success) {
