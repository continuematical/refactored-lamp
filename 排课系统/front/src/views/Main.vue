...
<div class="main" :class="{'main-hide-text': shrink}">
    <!--左边可收缩菜单栏-->
    <div class="sidebar-menu-con menu-bar" :style="{width: shrink ? '60px' : '160px', overflow: shrink ? 'visible' : 'auto'}">
                    ...
                    <Row type="flex" justify="end" align="middle" class="user-dropdown-innercon">
                        <Dropdown transfer trigger="hover" @on-click="handleClickUserDropdown">
                            ...
                            <a>
                                ...
                                <Avatar :src="avatarPath" style="margin-left: 10px;"></Avatar>
                            </a>
                            <DropdownMenu slot="list">
...
export default {
    ...
    computed: {
        ...
        avatarPath() {
            ...
            return 'https://img.picui.cn/free/2024/06/17/666f1b0643106.png';
        },
        cachePage() {
