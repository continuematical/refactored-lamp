...
<div class="search">
    <Card>
        <Row type="flex" justify="space-between">
            ...
            <Row :gutter="16">
                <Alert type="success" show-icon v-show="editTitle" style="margin-top: 8px;margin-left: 8px;margin-bottom: 0;">
                    <span class="select-title">{{editTitle}}</span>
                    <a class="select-clear" @click="cancelEdit" style="margin-left: 5px;">取消</a>
                </Alert>
            </Row>
            <Row :gutter="16">
                <Input v-model="searchKey" suffix="ios-search" @on-change="search" placeholder="输入搜索字典" clearable style="width:100% ;margin-left: 8px;margin-top: 8px;" />
            </Row>
            <Row :gutter="16">
