...
//    public void resummary(String oldKey, String newKey) {
//        redisTemplate.resummary(oldKey, newKey);
//    }
//
//    @Operation(summary = "仅当 newkey 不存在时，将 oldKey 改名为 newkey")
//    public Boolean resummaryIfAbsent(String oldKey, String newKey) {
//        return redisTemplate.resummaryIfAbsent(oldKey, newKey);
//    }
